            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-key">
                        ...
                        <h5>Orthopaedic</h5>
                        <p>Orthopaedics is the medical specialty that focuses on injuries and diseases of your
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-key">
                       <i class="fab fa-monero"></i>
                        <h5>Neurologist</h5>
                        <p>A neurologist is a medical doctor with specialized training in diagnosing, treating, and managing disorders of the brain .</p>
                    </div>
                </div>
