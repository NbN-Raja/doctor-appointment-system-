...
">
    <div class="container">
      <div class="row">
        <div class="col-lg-2 col-md-3 no-padding col-sm-12 nav-img">
          <img src="welcome/assets/images/logo.png" alt=""
            style="margin-left: -157px;height: 47px;width: 291px;margin-top: 14px; " />
  ...
  <body>
    ...
    <!-- ***************************************Register-Forms************************************ -->
    <div class="alert alert-warning alert-dismissible fade show" style="position: relative;
    top: 76px; color:red" role="alert">
  <strong>Alert!</strong> You should Login To Set Appointment
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <div class="main" style="display: flex; position: relative;top: 73px;     justify-content: space-around;">
    ...
    margin: 23px;">
        <form class="register" action="Appointment.php" method="POST">
          ...
          <label for="firstname"> <b> FULL Name: </b>
            <lable>
              ...
              <label for="Age"> Age: <lable>
                  ...
                  <label for="Location"> Address Detail: <lable>
                      ...
                      <input type="tel" id="phone" name="phone" placeholder="984-45-668" required><br><br>
      </div>
          ...
          <lable for="Mail"> Enter email</label>
            ...
            <lable for="reason"> Reason For Treatment <lable> <br>
                ...
                <div class="" style="margin-top: 10%;">
                  <input type="submit" name="submitq">
                </div>
