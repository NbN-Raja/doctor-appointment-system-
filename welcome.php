        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-caption vdg-cur d-none d-md-block">
              <h5 class="animated bounceInDown">Best Health medical care</h5>
              <p class="animated bounceInLeft">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                justo neque, <br />
                aliquet sit amet elementum vel, vehicula eget eros. Vivamus arcu
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12 txtr">
            <h4>
            Welcome to   doctpal <br />
              <span>More Than a Hospital. We are a Community</span>
            </h4>
            <p>
          ...
          <div class="col-lg-6 col-md-12">
            <img src="assets/images/bakular.jpg" style="width:90%; margin-top:30px" alt="" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-key">
              ...
              <p>
              Dermatologists (Skin Care Doctors) Dermatologists
              are experts in the care of normal skin,
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-key">
              ...
              <h5>pulmonologist</h5>
              <p>
              A pulmonologist is a physician who specializes in the respiratory system<br>
              From the
              </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-blog">
              ...
              <div class="blog-detail">
                <small style="color:black;">By Admin | August 10 2018</small>
